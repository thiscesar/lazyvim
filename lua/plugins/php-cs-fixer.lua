return {
  ...
  config = function()
    ...
    vim.api.nvim_set_keymap("n", "<leader>Pcd", ":call PhpCsFixerFixDirectory()<CR>", { noremap = true, silent = true })

    -- Mapeia o comando para corrigir o arquivo atual
    vim.api.nvim_set_keymap("n", "<leader>Pcf", ":call PhpCsFixerFixFile()<CR>", { noremap = true, silent = true })
